...
short SoftwareVersion = 1003;
short HardwareVersion = 1002;
short MotorVersion    = 1002;
...
//PIDTorque pidpt = PIDTorque_DEFAULTS;            //电流环 -速度模式用
...
short Uqs_OutMax = _IQ15(0.5);
short Uqs_OutMin = _IQ15(-0.5);
int Uqs_UiMax = _IQ30(0.5);
int Uqs_UiMin = _IQ30(-0.5);
short Uqs_Kp = 30;
short Uqs_Ki = 30;
...
short pidpv_OutMax = _IQ15(0.5);
short pidpv_OutMin = _IQ15(-0.5);
int pidpv_UiMax = _IQ30(0.5);
int pidpv_UiMin = _IQ30(-0.5);
short pidpv_Kp = 90;
short pidpv_Ki = 30;


short   pidc_position_OutMax = _IQ15(0.2);
short    pidc_position_OutMin = _IQ15(-0.2);
int   pidc_position_UiMax = _IQ30(0.2);
int   pidc_position_UiMin = _IQ30(-0.2);
short    pidc_position_Kp = 30;
short   pidc_position_Ki = 30;
