...
//    pdu[0] = SystemError.SysErr; //故障
//    pdu[1] = SystemError.DcVolt; //母线电压
//    pdu[2] = MotorControler.SpeedFdbp;   //当前速度 
//    pdu[3] = (MotorControler.MotorActivePostion) >> 16;    //当前位置
//    pdu[4] = (MotorControler.MotorActivePostion) & 0xffff; //当前位置
//    pdu[5] = SystemError.RuningModeFdb;                       //当前运行模式
//    pdu[6] = 0;
//    pdu[7] = 0;
//    pdu[8] = 0;
//    pdu[9] = 0;
